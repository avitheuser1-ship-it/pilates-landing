...
cover=table(doc,['פרט','מידע'],[
 ('סטודנט','עמית סולימן'),('מרצה','אבישי פרוינד'),('קורס','פרסום בגוגל'),('מספר חשבון Google Ads','580-214-1692'),('תאריך הגשה','12/07/2026')])
...
table(doc,['נכס / תוסף','יישום'],[
 ('Sitelinks','קישורים לדף יצירת קשר ולדפי המוצרים'),('Callouts','הדגשת יתרונות, יחס אישי וקבוצות קטנות'),('Structured snippets','הצגת סוגי השירותים'),('Call asset','מספר הטלפון 0525381648, ישראל'),('Countdown','נכס ספירה לאחור לקידום הצעה מוגבלת בזמן'),('מילים שליליות','סינון חיפושים שאינם רלוונטיים')])
...
add_para(doc,'העבודה מציגה תהליך מלא של הקמת פעילות פרסום עבור עסק שירותי: אתר עם דפי נחיתה וטופס, מדידת המרות, קמפיין חיפוש וקמפיין מותג, קמפיין מדיה עם רימרקטינג, קמפיין וידאו ומודעות התקשרות. כל הקמפיינים בחשבון נשמרו במצב מושהה בהתאם להנחיות המטלה.',size=11)
