...
table(doc,['נכס / תוסף','יישום / מצב'],[
 ('Sitelinks','קישורים לדף יצירת קשר ולדפי המוצרים — נכללו בייצוא'),('Callouts','הדגשת יתרונות, יחס אישי וקבוצות קטנות — נכללו בייצוא'),('Structured snippets','הצגת סוגי השירותים — נכללו בייצוא'),('Call asset','מספר הטלפון 0525381648, ישראל — קיים וממתין לבדיקה'),('Countdown','תוסף שנדרש להשלמה בחשבון לפני ההגשה הסופית'),('מילים שליליות','סינון חיפושים שאינם רלוונטיים')])
